import { WidgetSettings } from '@lib';
import type { KanbanConfig } from '../types';

const PLACEHOLDER: KanbanConfig = {
  statuses: ['Statut A', 'Statut B'],
  columns: {
    status: 'MaColonneStatut',
    title: 'MaColonneTitre',
    subtitle: 'MaColonneSousTitre',
    badges: [
      { key: 'MaColonneBadge', icon: 'label' },
    ],
    dueDate: 'MaColonneEcheance',
    assignee: 'MaColonneResponsable',
  },
};
